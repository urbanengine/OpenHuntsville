...
Pakyow::App.bindings :bhm_events do
    scope :bhm_events do
        restful :bhm_events
        ...
        options(:parent_event_selector) do
            get_events_for_bhm_coworkingnight()
        end
        ...
        binding(:approved) do
            ...
            if people.admin
                if bindable.approved
                    ...
                    content = "<p><a class='approve-btn' href='/bhm_events/approve/" + bindable.id.to_s + "'>Approve</a></p>"
                end
            end
            {
                :content => content
        ...
        binding(:delete_event_link) do
            ...
            if bindable.approved && isNotSiteAdmin
                ...
                # Either /bhm_events/new, or /bhm_events/:bhm_events_id/edit
        ...
        binding(:event_link) do
            {
            :content => bindable.name,
            :href => '/bhm_events/' + bindable.id.to_s
            }
        end

        binding(:approve_event_url) do
            {
                :href => '/bhm_events/approve/' + bindable.id.to_s
            }
        end
